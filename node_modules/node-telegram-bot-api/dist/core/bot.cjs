...
const compose_js_1 = require("./compose.cjs");
const context_js_1 = require("./context.cjs");
const longpoll_js_1 = require("./longpoll.cjs");
/**
...
class Bot {
    ...
    constructor(token, options) {
        this.api = new api_js_1.Api(token, options);
    }
    ...
    on(kind, ...handlers) {
        ...
        const run = (0, compose_js_1.compose)(handlers);
    ...
    async handleUpdate(update) {
        const ctx = new context_js_1.Context(update, this.api);
        try {
            await (0, compose_js_1.compose)(this.middleware)(ctx, () => Promise.resolve());
        }
        catch (err) {
     ...
     */
    async startPolling(source, options) {
        if (this.running) {
        ...
        this.running = true;
        const iterable = source ?? (0, longpoll_js_1.longPoll)(this.api, options, controller.signal);
        try {
