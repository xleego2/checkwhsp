...
exports.InputFile = exports.ATTACH_PREFIX = void 0;
exports.isInputFile = isInputFile;
exports.isFormPart = isFormPart;
...
class InputFile {
     ...
     */
    build(index) {
        return `${exports.ATTACH_PREFIX}media_${index}`;
    }
}
...
function isFormPart(value) {
    return typeof value === "object" && value !== null && value.__formPart === true;
}
/** Build a `FormPart` from a serialized JSON string and the files its refs point at. */
function formPart(json, files) {
