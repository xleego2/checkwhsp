...
export declare const ATTACH_PREFIX = "attach://";
/** Explicit, web-standard wrapper for uploadable bytes. */
export declare class InputFile {
    readonly data: InputFileData;
    readonly meta?: InputFileMeta | undefined;
    constructor(data: InputFileData, meta?: InputFileMeta | undefined);
    /**
...
export declare function isInputFile(value: unknown): value is InputFile;
/**
...
export declare function isFormPart(value: unknown): value is FormPart;
/** Build a `FormPart` from a serialized JSON string and the files its refs point at. */
export declare function formPart(json: string, files: ReadonlyArray<readonly [string, InputFile]>): FormPart;
