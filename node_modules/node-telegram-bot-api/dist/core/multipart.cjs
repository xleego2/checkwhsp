...
exports.supportsRequestStreams = supportsRequestStreams;
 ...
 */
function multipartBody(strings, files) {
...
async function* pieceChunks(pieces) {
...
async function bufferBody(pieces) {
    return new Response(streamBody(pieces)).blob();
}
let requestStreamsSupported;
