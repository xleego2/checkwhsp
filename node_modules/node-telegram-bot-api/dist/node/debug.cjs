...
exports.compileDebugFilter = compileDebugFilter;
exports.enableDebugFromEnv = enableDebugFromEnv;
const node_process_1 = __importDefault(require("node:process"));
const debug_js_1 = require("../core/debug.cjs");
/**
 ...
 */
function compileDebugFilter(env) {
    const names = [];
    const skips = [];
 ...
 */
function enableDebugFromEnv(env = node_process_1.default.env.DEBUG ?? "") {
    if (env.trim() === "") {
        (0, debug_js_1.setDebugSink)(undefined);
        return;
    }
    ...
    const sink = {
        ...
        write(namespace, line) {
            ...
            node_process_1.default.stderr.write(`${namespace} ${line}${delta}\n`);
        },
    };
    (0, debug_js_1.setDebugSink)(sink);
}
