...
export const generateMessageIDV2 = (userId) => {
  ...
  return 'DEXTERTECHDEVIL' + hash.toString('hex').toUpperCase().substring(0, 18)
}

export const generateMessageID = () => 'DEXTERTECHDEVIL' + randomBytes(18).toString('hex').toUpperCase()
...
export const fetchLatestBaileysVersion = async (options = {}) => {
  const URL = 'https://raw.githubusercontent.com/DEXTER-ID-NEW/dexter-tech-devil-baileys/master/lib/Defaults/index.js'
  try {
